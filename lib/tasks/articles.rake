namespace :articles do
  ...
  task seed: :environment do
		...
		Article.create(
	    title: "NYC Open Data Advocates Focus on Quality And Value Over Quantity",
	    company: "Tech President",
	    company_link: "http://techpresident.com/",
	    article_link: "http://techpresident.com/news/25201/nyc-open-data-advocates-focused-quality-over-quantity",
	    description: "Heat Seek aims to counter New York City heating code violations by using mesh networks of temperature sensors to report heating violations, aiding the housing court process, notifying tenants, lawyers and landlords, and integrating its reports with 311 data."
		)
