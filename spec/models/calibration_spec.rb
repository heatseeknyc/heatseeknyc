...
describe Calibration do
  ...
  let!(:calibration1) { FactoryBot.create(:calibration, offset: -2, start_at: 2.months.ago, end_at: 2.months.from_now) }
  let!(:calibration2) { FactoryBot.create(:calibration, offset: 4, start_at: 2.months.ago, end_at: 2.months.from_now) }
  ...
  describe ".apply!" do
    it "applies a relevant calibration" do
      calibration3 = FactoryBot.create(:calibration, offset: -5, start_at: 16.months.ago, end_at: 12.months.ago)
      calibration3.sensors << sensor1

      reading1 = FactoryBot.create(:reading, sensor: sensor1, temp: 70, created_at: 14.months.ago)
      reading2 = FactoryBot.create(:reading, sensor: sensor3, temp: 65)
    ...
    it "does not apply a calibration if there is not one" do
      reading = FactoryBot.create(:reading, sensor: sensor1, temp: 70, created_at: 14.months.ago)
  ...
  describe "#apply!" do
    it "raises error if calibration does not apply to sensor" do
      reading = FactoryBot.create(:reading, sensor: sensor1)
    ...
    it "raises error if calibration dates do not apply to reading" do
      ...
      reading = FactoryBot.create(:reading, sensor: sensor1, created_at: 1.month.ago)
      expect { calibration1.apply!(reading) }.to raise_error(ArgumentError)
    end

    it "applies calibration to reading" do
      reading = FactoryBot.create(:reading, sensor: sensor1, temp: 70)
    ...
    it "updates violation boolean" do
      reading = FactoryBot.create(:reading, sensor: sensor1, temp: 70, outdoor_temp: 30)
      calibration1.update(offset: -20)
  ...
  describe ".recalibrate!" do
    it "applies calibrations to respective readings" do
      reading1 = FactoryBot.create(:reading, sensor: sensor1, temp: 70, created_at: 14.months.ago)
      reading2 = FactoryBot.create(:reading, sensor: sensor1, temp: 71)
      reading3 = FactoryBot.create(:reading, sensor: sensor3, temp: 64)
      reading4 = FactoryBot.create(:reading, sensor: sensor4, temp: 60)
