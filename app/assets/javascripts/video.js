jQuery(document).ready(function ($) {
	...
	$('#play-button').on('click', function(e) {
		...
		videoContainer.prepend('<iframe src="//player.vimeo.com/video/100157167?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff&amp;autoplay=1" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
