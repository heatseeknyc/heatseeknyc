...
ComplaintsChartSvg.prototype.setSvg = function(){
...
ComplaintsChartSvg.prototype.setXScale = function(){
  var maxDate = this._setMinOrMax('max', this.data, function(d){
      return d.date; 
    }),
    minDate = this._setMinOrMax('min', this.data, function(d){
        return d.date;
    });
...
ComplaintsChartSvg.prototype.setYScale = function(){
  var maxTotal = this._setMinOrMax('max', this.data, function(d){ 
      return d.total + 10; 
    }),
      minTotal = this._setMinOrMax('min', this.data, function(d){
      return d.total - 10; 
    });
...
// private methods MAKE THIS A HELPER
ComplaintsChartSvg.prototype._normalizeData = function(dataObj){
...
ComplaintsChartSvg.prototype._setMinOrMax = function(minOrMax, dataObj, callBack){
  var arr = [];
  for (var borough in dataObj) {
    if( dataObj.hasOwnProperty( borough ) ) {
      dataObj[borough].forEach(function(obj){
